...
// filter — This is an another function which keeps the elements that pass a test
let passing = scores.filter(s => s > 70);
console.log(passing); // [ 82, 91, 73 ]
// (s => s > 70); - This line means find all the score, where score is 
// greater than 70


// reduce - accumulates to a single value
let total = scores.reduce((a, b) => a + b, 0); // It is actually doing sum of elements
